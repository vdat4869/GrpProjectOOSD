...
const sections: SidebarSection[] = [
  {
    ...
    links: [
      ...
      { label: "Vehicle Schedule", path: "/coowner/schedule", icon: <CalenderIcon /> },
      { label: "Payment History", path: "/coowner/payments", icon: <DollarLineIcon /> },
      { label: "Transaction History", path: "/coowner/transactions", icon: <DollarLineIcon /> },
      { label: "Payment Methods", path: "/coowner/payment-methods", icon: <DollarLineIcon /> },
