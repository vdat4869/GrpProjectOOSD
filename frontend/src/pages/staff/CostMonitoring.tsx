...
const CostMonitoring: React.FC = () => {
  ...
  return (
    <>
      <PageMeta title="Staff | Cost Monitoring" />
      <PageHeader
        title="Cost Monitoring"
        description="Track costs incurred during vehicle usage and assist in generating detailed reports for admin."
        ...
        <div className="grid gap-4">
          {filteredCostShares().length === 0 ? (
            <div className="rounded-2xl border border-gray-200 bg-white p-6 text-center shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
              <p className="text-gray-600 dark:text-gray-400">No cost shares found for this group.</p>
            </div>
          ) : (
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Amount: {formatAmount(costShare.totalAmount)}
                      </p>
