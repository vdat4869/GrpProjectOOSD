...
// Infrastructure Services (RabbitMQ and Redis)
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "EV Co-ownership Ownership Service API",
        Version = "v1",
        Description = "Microservice for managing vehicle ownership, groups, contracts, voting, and group funds"
    });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Ownership Service API v1");
...
// Subscribe to RabbitMQ events if needed
var logger = app.Services.GetRequiredService<ILogger<Program>>();
logger.LogInformation("Ownership Service started with RabbitMQ and Redis integration");
