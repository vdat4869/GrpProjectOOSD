...
public class ReportDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<UsageHistory>(entity =>
        {
            ...
            entity.Property(e => e.StartBatteryLevel).IsRequired().HasPrecision(5, 2);
            entity.Property(e => e.EndBatteryLevel).IsRequired().HasPrecision(5, 2);
            entity.Property(e => e.EnergyConsumed).IsRequired().HasPrecision(10, 2);
        ...
        modelBuilder.Entity<ChargingSession>(entity =>
        {
            ...
            entity.Property(e => e.EnergyConsumed).IsRequired().HasPrecision(10, 2);
            entity.Property(e => e.Cost).IsRequired().HasPrecision(18, 2);
            entity.Property(e => e.ChargingPower).HasPrecision(10, 2);
            entity.Property(e => e.CreatedAt).IsRequired();
            entity.Property(e => e.UpdatedAt).IsRequired();
            entity.Property(e => e.IsActive).IsRequired();
        ...
        modelBuilder.Entity<MaintenanceRecord>(entity =>
        {
            ...
            entity.Property(e => e.Cost).IsRequired().HasPrecision(18, 2);
            entity.Property(e => e.MileageAtService).IsRequired().HasPrecision(10, 2);
